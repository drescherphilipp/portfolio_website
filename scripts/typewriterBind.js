  $(function () { // wait for document ready
    /*
    var header_object = document.getElementById('header_name');
    var header_typewriter = new Typewriter(header_object, { loop: false });
    header_typewriter.typeString('Philipp Drescher').start();
    */
  });
